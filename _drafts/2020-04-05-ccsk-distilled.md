...
- Primary _role_ of Information security is to **provide processes** and **controls** to protect electronic information and the systems use to access it. 
...
- Customer has to address any governance gap if there is an area that is not covered in the contract. Customer is expected to adjust their own processes to close this gap.
...
- IAAS is closer to traditional data centre and existing governance and risk management activities are transferable. 
...
- MFA offers strongest option for reducing account takeovers. 
